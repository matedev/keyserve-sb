    ...
    <div class="content-main" id="page-services">
      ...
      <div id="block1" class="block">
        <div class="container text-center">
          <p class="text-title">Szolgáltatások</p>
          <p class="text-normal col-md-10 col-md-push-1">
            Hogyan rendelkezhet hagyományokkal, szilárd szakmai alapokkal, sőt, hírnévvel egy társaság, a Keyserve Kft.?
            Természetesen vezető munkatársain keresztül. Neves rendszerintegrátor és tanácsadó cégek által nagyvállalati, állami ügyfeleknél levezényelt jelentős informatikai projektekben szereztük az informatikai szolgáltatások menedzselésével kapcsolatos tapasztalatainkat, valamint projektvezetési gyakorlatunkat. Különféle rendszerfelügyeleti és szolgáltatástámogató eszközök implementálása mellett – és azon túl – figyelmünk egyre inkább a kapcsolódó folyamatok fejlesztése, az emberi és kommunikáció tényezők felé fordult.  Az ember–eszköz–folyamat hármasa (a jól ismert 3P
            odell) így mindennapi gondolkodásunk legfontosabb jellegzetességévé, holisztikus megközelítésünk és munkamódszerünk bázisává vált.
          </p>
        </div>
      </div>
